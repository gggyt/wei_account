...
class AddLecture extends React.Component {
  ...
  saveLecture() {
    ...
    fetch(AddLectureUrl,{   //Fetch方法
            ...
            body: 'lectureTitle='+this.state.title+'&lectureBody='+encodeURI(this.state.editorContent)+'&date='+this.state.data
  ...
  updateLecture() {
    ...
    fetch(UpdateLectureUrl,{   //Fetch方法
            ...
            body: 'lectureId='+this.state.lectureId+'&lectureTitle='+this.state.title+'&lectureBody='+encodeURI(this.state.editorContent)+'&date='+this.state.data
